...
//  Utility
//
//  Created by Goyal, Pratik on 21/03/21.
//
...
//    public let database = Database.database().reference()
    ...
    static func decodeEmail(emailAddress : String) -> String {
        var decodeEmail = emailAddress.replacingOccurrences(of: "-", with: ".")
        return decodeEmail
    }
}
...
////    public func createNewConversation(with otherUserEmail : String, name : String, firstMessage : Message,
////                                      completion : @escaping (Bool) -> Void){
